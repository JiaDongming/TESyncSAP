...
namespace SAPSyncAPI
{
 ...
 public delegate List<ReturnMessage> DelegateSyncSAP(ProjectBinder projectBinder);
    ...
    public  class DelegateHandler
    {
        #region 新建项目时的执行逻辑
        //新建项目
        public List<ReturnMessage> SyncProjectInfo(ProjectBinder projectBinder)
        {
            ...
            try
            {
                ...
                if (project == null)
                {
                    LogHelper.WriteLog("Project is not exist, please check it");
                    return null;
                }
         ...
         return  sapSync.InvokeRFCFunctionZPSRFC03(project, wbs);
